...
import { appointments } from '../Schedule/demo-data/appointments';
...
class AppointmentFormContainerBasic extends React.PureComponent {
    ...
    render() {
        const { visible, visibleChange, appointmentData, cancelAppointment, target, onHide } = this.props;
        const { appointmentChanges } = this.state;
...
export default class Demo extends React.PureComponent {
    constructor(props) {
        ...
        this.appointmentForm = connectProps(AppointmentFormContainerBasic, () => {
            ...
            const currentAppointment =
                data.filter((appointment) => editingAppointment && appointment.id === editingAppointment.id)[0] || addedAppointment;
    ...
    render() {
        const { currentDate, data, confirmationVisible, editingFormVisible, startDayHour, endDayHour } = this.state;
