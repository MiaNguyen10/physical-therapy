...
const steps = [
  ...
  },
  {
    ...
    description:
      `Hình thức chủ động của vật lý trị liệu bao gồm các bài tập vận động thể lực, 
...
export default function CarouselText() {
  ...
  return (
    <Box sx={{flexGrow: 1 }}>
      ...
      >
        <Typography sx={{fontWeight:'bold', fontSize: '30px', alignItems: 'left'}}>{steps[activeStep].label}</Typography>
      </Paper>
      <Box sx={{ height: 255, maxWidth: 400, width: '100%', mt: 3 }}>
